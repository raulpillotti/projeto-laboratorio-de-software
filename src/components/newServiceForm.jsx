      ...
      <Box> 
            <FormControl fullWidth>
                <InputLabel htmlFor={'name'}>{'Nome do serviço'}</InputLabel>
                    <Input onChange={(e)=> {name.current = e.target.value}} id={'name'} fullWidth/>
            </FormControl>
            ...
            <FormControl fullWidth>
                <InputLabel htmlFor='Valor'>{'Valor'}</InputLabel>
                    <Input onChange={(e)=> {value.current = e.target.value}} id={'Valor'} fullWidth type={'number'}/>
            </FormControl>
          ...
          <Select 
            ...
            <Buttons> 
                <Button variant = 'contained' onClick={()=>publishService()}> Confirmar</Button>
                <Button variant = 'contained' onClick={()=>{props.onClose()}}> Cancelar</Button>
            </Buttons>
       </Box>
    );
  }